@echo off
REM One-click build script for MIDI Chord Detector Standalone App
REM Simple batch file that calls the PowerShell script for standalone

echo.
echo ========================================
echo   MIDI Chord Detector - Standalone Build
echo ========================================
echo.
...
if %ERRORLEVEL% EQU 0 (
    ...
    if %ERRORLEVEL% EQU 0 (
        ...
        pwsh -ExecutionPolicy Bypass -File "%~dp0build_standalone.ps1"
    ) else (
